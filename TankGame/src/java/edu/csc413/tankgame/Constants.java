...
public class Constants {
    ...
    public static final double HOMING_SHELL_TURN_SPEED = Math.toRadians(1.0);

    public static final double WALL_WIDTH = 32.0;
    public static final double WALL_HEIGHT = 32.0;
    
    public static final double POWERUP_WIDTH = 32.0;
    public static final double POWERUP_HEIGHT = 32.0;
