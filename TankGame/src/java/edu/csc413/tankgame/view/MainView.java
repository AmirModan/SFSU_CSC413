...
public class MainView {
    ...
    public MainView(ActionListener startMenuListener) {
        ...
        StartMenuView pauseMenuView = new StartMenuView("Resume Game", "Restart Game", startMenuListener);
    ...
    public void setScreen(Screen screen) {
        ...
        Dimension screenSize = switch (screen) {
            case START_GAME_SCREEN, PAUSE_MENU_SCREEN, END_MENU_SCREEN -> StartMenuView.SCREEN_DIMENSIONS;
